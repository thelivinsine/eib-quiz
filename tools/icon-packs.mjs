...
const solid = {
    ...
    book: '<path d="M11 6.6C9.2 5.2 6.9 4.4 4.5 4.4c-.7 0-1.4.1-2.1.2a1.1 1.1 0 0 0-.9 1.1v11.6a1.1 1.1 0 0 0 1.4 1.1c.5-.1 1.1-.2 1.6-.2 2.2 0 4.3.8 6 2.2.1.1.3.1.5 0Z"/><path d="M13 6.6c1.8-1.4 4.1-2.2 6.5-2.2.7 0 1.4.1 2.1.2a1.1 1.1 0 0 1 .9 1.1v11.6a1.1 1.1 0 0 1-1.4 1.1c-.5-.1-1.1-.2-1.6-.2-2.2 0-4.3.8-6 2.2-.1.1-.3.1-.5 0Z"/>',
