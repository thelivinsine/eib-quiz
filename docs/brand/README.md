...
- **The tagline says "Practise", not "Practice":** "Learn. Practise. Pass." is the app's
  ...
  The mockup's "Practice" was corrected on 2026-09-23 and the kit was re-run. Its
  floating middots became a full stop and a space after each word the same day, on
  request, and the kit was re-run again.
